...
data["last"] = data.line.str.extract(r".*(\d)")
data["combined"] = data["first"] + data["last"]
...
data["last"] = data.line.str.extract(r".*(\d|one|two|three|four|five|six|seven|eight|nine|zero)")
...
data["first"] = data["first"].map(number_map).fillna(data["first"])
data["last"] = data["last"].map(number_map).fillna(data["last"])
data["combined"] = data["first"] + data["last"]
data["combined"] = data["combined"].astype("int")
